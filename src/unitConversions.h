...
// PID defaults
#define DEFAULT_KP						0.2f					// Default Kp value
#define DEFAULT_KI						0.0005f					// Default Ki value
#define DEFAULT_MAXERR					1.0f
#define DEFAULT_MINERR					-1.0f
#define DEFAULT_MAXI					50.0f					// Maximum integral value - +2 rad/sec = 2 / 0.001 = 2000
#define DEFAULT_MINI					-50.0f					// Minimum integral value
